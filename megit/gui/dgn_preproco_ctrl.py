...
# Form implementation generated from reading ui file 'E:\MEGIT\megit\gui\dgn_preproco_ctrl.ui'
#
...
class Ui_ControlViewer(object):
    ...
    def retranslateUi(self, ControlViewer):
        ...
        self.tgtLabel.setText(_translate("ControlViewer", "Target Regions"))
        self.juvLabel.setText(_translate("ControlViewer", "Juvenile Regions"))
        self.tgtBox.setItemText(0, _translate("ControlViewer", "[NONE]"))
        self.tgtBox.setItemText(1, _translate("ControlViewer", "Centre"))
        self.tgtBox.setItemText(2, _translate("ControlViewer", "Right/Top"))
        self.tgtBox.setItemText(3, _translate("ControlViewer", "Left/Buttom"))
        self.juvBox.setItemText(0, _translate("ControlViewer", "[NONE]"))
        self.juvBox.setItemText(1, _translate("ControlViewer", "Centre"))
        self.juvBox.setItemText(2, _translate("ControlViewer", "Right/Top"))
        self.juvBox.setItemText(3, _translate("ControlViewer", "Left/Buttom"))
